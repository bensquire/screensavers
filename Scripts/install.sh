...
SAVER="build/Solar System.saver"
DEST="$HOME/Library/Screen Savers/Solar System.saver"
...
codesign --force --sign - --timestamp=none "$DEST/Contents/MacOS/SolarSystemSaver"
