...
public final class SolarSystemSaverView: ScreenSaverView {
    ...
    private static var preferences: ScreenSaverDefaults? {
        ScreenSaverDefaults(forModuleWithName: ScalePreset.Preference.domain)
    }
    ...
    public static var scalePreset: ScalePreset {
        get {
            ...
            for raw in [
                preferences?.string(forKey: ScalePreset.Preference.key),
                UserDefaults.standard.string(forKey: ScalePreset.Preference.fallbackKey),
            ] {
        ...
        set {
            ...
            UserDefaults.standard.set(newValue.rawValue, forKey: ScalePreset.Preference.fallbackKey)
            os_log(
